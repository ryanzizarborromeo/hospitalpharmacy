          ...
          <div class="col-sm-8">
            <form action="changeRefNo.php" method="post" class="form-inline pull-right">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="refno" value="<?php if(isset($_SESSION['refNo'])){ echo $_SESSION['refNo'];}?>" required="">
              </div>
              <input type="submit" class="btn btn-primary btn-flat" name="submit" value="Set"></input>
            </form>
          </div>
        </div>
