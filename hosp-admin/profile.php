...
if(isset($_POST['postnew']))
{
  if(isset($_POST['post_content']) && $_POST['post_content'] != ""){
    ...
    try{
      $timeNow = time();
      $stmt = $conn->prepare("INSERT INTO `tblannouncements`(`UID`, `Content`, `DateAdded`) VALUES (:uid , :content , :dateposted)");
      $stmt->bindParam(':uid', $_SESSION['user_id']);
      $stmt->bindParam(':content',e($_POST['post_content']));
      $stmt->bindParam(':dateposted', $timeNow);
      $stmt->execute();
      $conn = null;
      header('Location: profile.php?success=Announcement posted successfully!');
    }
  ...
  {
    header('Location: profile.php?error=Announcement can not be blank!');
  }
}
?>
<!DOCTYPE html>
...
<div class="wrapper">
  <header class="main-header">
    <a href="../index.php" class="logo">
      ...
      <span class="logo-lg"><b>DPOTMH Admin </b></span>
    </a>
        ...
        <div class="col-md-3">
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              ...
              ?>
              <img class="img-responsive" src="<?php echo $_SESSION['AccImg'];?>" alt="Chania" >
              <hr>
              ...
              <form action="changepic.php" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                  ...
                  <div class="form-group has-feedback">
                    <input required="" pattern=".{8,}" required title="Minimum 8 characters required" type="password" class="form-control" placeholder="Password" required="" name="pass_word">
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                  </div>
                </div>
                <div class="modal-footer">
                  <input required=""  type="submit" class="btn btn-primary pull-right" name="changepic" value="Change"></input>
                </div>
              </form>
            </div>
          </div>
              ...
              while($r = $results->fetch()){
                ...
                <div class='item'>
                  ...
                  <p class='message'>
                    ...
                    ".$r['Content']."<br>
                    <a class='pull-right' data-toggle='modal' data-target='#deletemodal' href='delete-announcement.php?aid=".$r['AID']."'>Delete</a>
                  </p>
                </div>
                ";
              }
          ...
          <div class="box box-danger" id="changeUser">
            ...
            <div class="box-body">
              <form action="change-username.php" method="post">
                ...
                <div class="modal-footer">
                  <input required=""   type="submit" class="btn btn-primary pull-right" name="submit" value="Change Username"></input>
                </div>
              </form>
            </div>
          </div>
          <div class="box box-danger" id="changePass">
            ...
            <div class="box-body">
              <form action="change-password.php" method="post">
                ...
                <div class="modal-footer">
                  <input required=""   type="submit" class="btn btn-primary pull-right" name="submit" value="Change Password"></input>
                </div>
              </form>
            </div>
          </div>
